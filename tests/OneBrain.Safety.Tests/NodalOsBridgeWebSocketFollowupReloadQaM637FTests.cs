...
[TestClass]
[TestCategory("BridgeWebSocketFollowupReloadQa")]
[TestCategory("M637F")]
public sealed class NodalOsBridgeWebSocketFollowupReloadQaM637FTests
{
    private const string ResultPath = "artifacts/agent-operations/m637f/bridge-websocket-followup-reload-qa-result.json";
    private const string SummaryPath = "artifacts/agent-operations/m637f/bridge-websocket-followup-reload-qa-summary.json";
    private const string GoNoGoPath = "artifacts/agent-operations/m637f/post-m637f-go-no-go.json";
    private const string ReportPath = "docs/reports/bridge-websocket-followup-reload-qa-m637f.md";
