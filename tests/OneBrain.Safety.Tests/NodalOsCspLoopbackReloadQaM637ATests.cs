...
[TestClass]
[TestCategory("CspLoopbackReloadQa")]
[TestCategory("M637A")]
public sealed class NodalOsCspLoopbackReloadQaM637ATests
{
    private const string ResultPath = "artifacts/agent-operations/m637a/csp-loopback-reload-qa-result.json";
    private const string SummaryPath = "artifacts/agent-operations/m637a/csp-loopback-reload-qa-summary.json";
    private const string GoNoGoPath = "artifacts/agent-operations/m637a/post-m637a-go-no-go.json";
    private const string ReportPath = "docs/reports/csp-loopback-reload-qa-m637a.md";
    ...
    [TestMethod]
    public void ResultIncludesTcpProbe1270018787()
    {
        using var doc = ReadJson(ResultPath);
        doc.RootElement.GetProperty("tcpProbe1270018787");
    }
    ...
    [TestMethod]
    public void ResultIncludesRuntimeConnectionObserved()
    {
        using var doc = ReadJson(ResultPath);
        doc.RootElement.GetProperty("runtimeConnectionObserved");
    }
    ...
    {
        using var doc = ReadJson(ResultPath);
        doc.RootElement.GetProperty("errConnectionRefusedPresent");
    }
    ...
    [TestMethod]
    public void GoNoGoKeepsReleaseEvidenceGateBlockedBecauseQaFailed()
    {
    ...
    [TestMethod]
    public void ManifestJsonUnchangedFromM637()
    {
