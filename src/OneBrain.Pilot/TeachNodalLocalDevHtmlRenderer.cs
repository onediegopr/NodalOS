    ...
    internal static string Render(TeachNodalLocalDevOperatorSnapshot snapshot)
    {
        ...
        return $$$"""
          ...
          <body><div class="shell" data-nodal-os="teach-nodal" data-local-dev-only="true" data-read-only="true" data-fixture-only="true" data-product-authority="false">
            ...
            <footer class="bottom">Local/dev read-only teaching review. No live recorder, hooks, raw screenshots, raw DOM, network, execution authority or production exposure.</footer>
          </div></body></html>
          """;
    }
