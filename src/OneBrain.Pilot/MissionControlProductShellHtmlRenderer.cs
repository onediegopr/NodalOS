...
<body data-nodal-os="mission-control-product-shell" data-local-only="@@LOCAL_ONLY@@" data-read-only="@@READ_ONLY@@" data-fixture-backed="@@FIXTURE_BACKED@@" data-workspace-selected="@@WORKSPACE_SELECTED@@" data-workspace-persisted="@@WORKSPACE_PERSISTED@@" data-real-mission-draft="@@REAL_MISSION_DRAFT@@" data-mission-draft-persisted="@@MISSION_DRAFT_PERSISTED@@" data-action-execution-enabled="@@ACTION_EXECUTION_ENABLED@@" data-action-approval-available="@@ACTION_APPROVAL_AVAILABLE@@" data-action-execution-state="@@ACTION_EXECUTION_STATE@@" data-action-executed="@@ACTION_EXECUTED@@" data-action-verified="@@ACTION_VERIFIED@@" data-rollback-available="@@ROLLBACK_AVAILABLE@@" data-action-rolled-back="@@ACTION_ROLLED_BACK@@" data-product-authority="@@PRODUCT_AUTHORITY@@">
  <div class="shell">
    <aside class="sidebar">
      ...
      <nav aria-label="Navegación principal"><a class="nav-link active" href="/"><span class="nav-dot"></span><span>Mission Control</span></a><a class="nav-link" href="#timeline"><span class="nav-dot"></span><span>Timeline</span></a><a class="nav-link" href="/workspace/select"><span class="nav-dot"></span><span>Workspace</span></a><a class="nav-link" href="/mission/new"><span class="nav-dot"></span><span>Mission</span></a><a class="nav-link" href="/mission/execution"><span class="nav-dot"></span><span>Approval</span></a><a class="nav-link" href="/ai/config"><span class="nav-dot"></span><span>Models</span></a><a class="nav-link" href="#evidence"><span class="nav-dot"></span><span>Evidence</span></a><a class="nav-link" href="/guia"><span class="nav-dot"></span><span>Settings</span></a></nav>
    ...
    <main class="workspace">
      ...
      <div class="content-grid"><section class="panel" id="timeline" data-section-id="timeline"><div class="panel-header"><h2>Timeline de misión</h2><span>@@TIMELINE_COUNT@@ eventos</span></div><div class="timeline">@@TIMELINE@@</div></section><aside class="panel" data-section-id="context"><div class="panel-header"><h2>Contexto activo</h2><span>runtime</span></div><div class="context-list">@@CONTEXT@@</div><div class="fallback-note"><strong>Último fallback</strong><br>@@FALLBACK@@</div>@@ACTION_CANDIDATE@@</aside></div>
      <div class="lower-grid"><section class="panel" id="evidence" data-section-id="evidence"><div class="panel-header"><h2>Evidencia</h2><span>refs redacted</span></div><div class="evidence-list">@@EVIDENCE@@</div></section><section class="panel" data-section-id="next-step"><div class="panel-header"><h2>Próximo gate productivo</h2><span>@@NEXT_STAGE@@</span></div><div class="empty">@@NEXT_GATE@@<br><a class="product-cta" href="@@NEXT_HREF@@">@@NEXT_ACTION@@</a></div></section></div>
      <details data-section-id="diagnostics"><summary>Diagnóstico técnico y eventos</summary><div class="diagnostics">@@DIAGNOSTICS@@</div></details><div class="footer"><span>Local-only · bounded mission control · sin product authority</span><a href="/pilot/legacy">Abrir laboratorio Pilot legado</a></div>
    </main>
  </div>
</body>
</html>
""";
    ...
    private static (string Stage, string Text, string Action, string Href) NextGate(MissionControlProductShellSnapshot snapshot)
    {
