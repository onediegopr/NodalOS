  ...
  <main>
    ...
    <section class="grid">
      ...
      <div class="card">
        ...
        <p><a class="button ghost" href="/pilot/legacy/pilot/legacy/ai/config">Abrir configuracion de IA</a></p>
      </div>
...
<body>
  <main>
    ...
    <section class="card">
      ...
      <form method="post" action="/pilot/legacy/pilot/legacy/pilot/legacy/pilot/legacy/ai/config/test">
...
<body>
  <main>
    ...
    <section class="card">
      ...
      <p><a class="button" href="/">Volver al inicio</a> <a class="button" href="/pilot/legacy/pilot/legacy/ai/config">Ver configuracion IA</a></p>
    </section>
...
<section class="card" aria-label="Navegacion y seguridad de Pilot">
  ...
  <nav style="display:flex;flex-wrap:wrap;gap:10px;margin:10px 0 14px">
    ...
    <a class="button" href="/pilot/legacy/pilot/legacy/ai/config">Configuracion</a>
  </nav>
