...
public static class WebTargetResultIdentityMapper
{
    public static ElementIdentity? ToSelectedIdentity(WebTargetResult result)
    {
    ...
    public static IdentityStrength ResolveIdentityStrength(WebTargetResult result)
    {
        ArgumentNullException.ThrowIfNull(result);
