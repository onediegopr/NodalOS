...
public sealed class ProductLedgerPathWriterScaffoldDisabled
{
    public const string DisabledWriterScaffoldStatus =
        "DISABLED_WRITER_SCAFFOLD_TEST_ONLY HISTORICAL_NON_AUTHORITATIVE NO_ACTIVE_PRODUCT_LEDGER_PATH NO_PRODUCT_LEDGER_WRITE NO_PRODUCT_RUNTIME_ENABLEMENT NO_PRODUCT_SERVICE_REGISTRATION NO_COMMAND_HANDLERS NO_UI_PRODUCT_ACTIONS NO_RELEASE_COMMERCIAL NO_EXTERNAL_TRUST NO_WORM_KMS_CLOUD";
