...
workflow = Path(".github/workflows/desktop-package.yml")
replace_once(
    workflow,
    '      - "eng/packaging/**"\n',
    '      - "eng/packaging/**"\n'
...
replace_once(
    workflow,
    './eng/ci/smoke-desktop-package.ps1 -Version "0.1.0.3"',
    './eng/ci/smoke-desktop-package.ps1 -Version "0.1.0.4"',
)

for temporary_path in (
    ".github/workflows/one-shot-integrate-third-party-notices.yml",
    ".github/workflows/one-shot-integrate-third-party-notices-pr.yml",
    ".github/workflows/one-shot-third-party-notice-audit.yml",
    "eng/ci/one-shot-integrate-third-party-notices.py",
):
